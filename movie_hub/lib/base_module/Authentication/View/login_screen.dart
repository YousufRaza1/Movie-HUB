                ...
                children: [
                  ...
                  Container(
                    ...
                    child: ElevatedButton(
                      onPressed: _authViewModel.isLoading == true  ? null: () async {


                        await _authViewModel.signInWithEmailAndPassword(userEmail, password,context);
                      ...
                      child: Text(
                        _authViewModel.isLoading == true ? 'Loaging':'Sign in',
                        style: TextStyle(
                            color: Colors.white,
